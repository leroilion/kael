...
\section*{Lynsey Sterlin}

\textbf{Référence d'origine :} Lindsey Stirling

\textbf{Domaine :} Musique

\textbf{Artiste :} Lindsey Stirling

\referencebreak

Lindsey Stirling est une violoniste, compositrice et danseuse américaine,
notamment connue pour associer le violon à des chorégraphies très dynamiques.
Ses performances mêlent ainsi étroitement musique et mouvement, le violon
faisant pleinement partie de la danse.

\referencebreak

Dans notre histoire, Lynsey Sterlin reprend principalement cette association
entre le violon et la danse. Kamatsu la découvre alors qu'elle joue dans une
taverne, se déplaçant entre les tables au rythme de sa musique. Lorsqu'il se
joint spontanément à son chant puis à sa danse, elle l'encourage à participer
à la représentation.

Pendant une pause, Kamatsu découvre qu'elle connaît également Thom Merilin,
avec qui il a commencé à apprendre le chant et la musique. Intrigué par son
violon, il lui demande quelques explications et tente même d'en jouer, avec
des résultats nettement moins harmonieux que ceux de Lynsey.

Cette rencontre donne à Kamatsu l'envie d'apprendre lui-même le violon. En
quittant la ville, il emporte avec lui un vieil instrument d'occasion, usé
mais encore parfaitement capable de sonner juste, à condition que son
violoniste apprenne à en faire autant.
